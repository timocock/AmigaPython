...
#ifdef _AMIGA
/* Replace file object methods with AmigaDOS equivalents */
static PyMethodDef amiga_file_methods[] = {
    {"seek", amiga_file_seek, METH_VARARGS},
    {"read", amiga_file_read, METH_VARARGS},
    ...
};
#endif
